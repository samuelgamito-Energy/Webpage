```{ojs}
//| echo: false
// COMPONENTE: INTERFAZ VISUAL (VISTA) - CORREGIDO
          ...
          <table class="mini-table">
            ...
            <tbody>
              ${filteredTableData.sort((a,b) => (b.V2024||0) - (a.V2024||0)).map(row => {
                // CORRECCIÓN AQUÍ: No usamos toFixed() todavía para mantenerlo como número
                const trend = row.V2023 > 0 ? ((row.V2024 - row.V2023)/row.V2023 * 100) : 0;
                ...
                return htl.html`<tr style="border-bottom:1px solid #334155;">
                  ...
                  <td class="col-dato" style="font-weight:700; color:#cbd5e1;">${(row.V2024||0).toLocaleString("es-ES")}</td>
                  <td class="col-trend"><span class="${trend>=0?'trend-up':'trend-down'}">${trend > 0 ? '+' : ''}${trend.toFixed(1)}%</span></td>
                  <td class="col-action">
