...
/* Sistema de Pestañas (Igual al FNEE pero oscuro) */
.tab-nav {
...
.custom-table td {
  padding: 15px; border-bottom: 1px solid #334155; color: #e2e8f0;
}
...
// 1. DATOS REALES (INCRUSTADOS Y SEGUROS)
